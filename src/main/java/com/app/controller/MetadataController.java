...
public class MetadataController {
    ...
    @GetMapping
    public Page<FileMetadata> getAll(
    ...
    @GetMapping("/search")
    public Page<FileMetadata> searchByName(
    ...
    public Page<FileMetadata> bucket(
    ...
    public Page<FileMetadata> status(
